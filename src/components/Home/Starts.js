...
const Starts = () => {
	...
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4 border p-10">
		<div data-aos="zoom-in" data-aos-duration="1000" className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:text-gray-100">
			...
			<div className="flex flex-col justify-center align-middle">
				...
				<p className="capitalize">Happy Traveler</p>
			</div>
		</div>
		<div data-aos="zoom-in" data-aos-duration="1000" className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:text-gray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-blue-400">
			...
			<div className="flex flex-col justify-center align-middle">
				...
				<p className="capitalize">Tent Sites</p>
			</div>
		</div>
		<div data-aos="zoom-in" data-aos-duration="1000" className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:text-gray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-blue-400">
		...
		<div data-aos="zoom-in" data-aos-duration="1000" className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:text-gray-100">
			...
			<div className="flex flex-col justify-center align-middle">
				<p className="text-3xl font-semibold leading-none">24 k+</p>
				<p className="capitalize">Awards Winning</p>
			</div>
		</div>
	</div>
</section>
