...
const Starts = () => {
    return (
        <section className="px-28  py-14  text-gray-800  bg-gray-200">
	<div className="content-center justify-center grid grid-cols-1 gap-6 p-4  md:m-0 md:grid-cols-2 xl:grid-cols-3">
		<div className="flex overflow-hidden rounded-lg text-gray-900 border border-gray-500">
		...
		<div className="flex overflow-hidden rounded-lg text-gray-900 border border-gray-500">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-2xl font-semibold">7 <CountUp start={450} end={500} duration={3}></CountUp>+</p>
				<p>Customers</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg text-gray-900 border border-gray-500">
