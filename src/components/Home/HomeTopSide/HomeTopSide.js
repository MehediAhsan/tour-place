    ...
    return (
        <div className='container mx-auto p-28'>
            ...
            <div className="text-center text-neutral-content">
                ...
                <h1 className="mb-5 font-bold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-rose-500 to-yellow-500">{name}</h1>
                ...
                <Link to={`/booking/${id}`}>
                    <button type="button" className="px-4 py-2 bg-gradient-to-r from-rose-500 to-yellow-500 hover:from-yellow-500 hover:to-rose-500 text-white rounded text-lg">Booking</button>
                </Link>
                </div>
            </div>
        </div>
