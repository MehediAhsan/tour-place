...
const Steps = () => {
	...
	<div className="container mx-auto flex flex-col p-6">
		<h2 className="py-4 text-4xl font-semibold text-center text-gray-200">How It Works</h2>
		<div className="divide-y divide-gray-700">
			
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				<div className="flex items-center justify-center lg:col-span-1 col-span-full">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-12 h-12 text-rose-600">
				...
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase text-gray-200">Step 1 - 
Safety first always</span>
					<span className="text-xl font-semibold md:text-2xl">Prioritize safety in all our adventures.</span>
			...
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				...
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase text-gray-200"> Step 2 - Book Your Adventure</span>
					<span className="text-xl font-semibold md:text-2xl">Explore and book your dream adventure.</span>
