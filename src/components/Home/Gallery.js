...
<div class="flex min-h-screen w-full flex-wrap content-center justify-center p-5 ">
  ...
  <div class="grid grid-cols-2 gap-3">
    ...
    <div class="w-80 bg-white p-3">
      <img alt='' class="h-52 w-full object-cover" src="https://thesimpletravel.com/wp-content/uploads/2022/02/Tourist-Places-in-Bangladesh.jpg" />
      <ul class="mt-3 flex flex-wrap">
        <li class="mr-auto">
          <a href="#" class="flex text-gray-400 hover:text-gray-600">
            <svg class="mr-0.5" style={{width:"24px",height:"24px"}} viewBox="0 0 24 24">
    ...
    <div class="w-80 bg-white p-3">
      <img alt='' class="h-52 w-full object-cover" src="https://www.tbsnews.net/sites/default/files/styles/big_2/public/images/2020/09/27/sajek_valley_d.jpg" />
      <ul class="mt-3 flex flex-wrap">
        <li class="mr-auto">
          <a href="#" class="flex text-gray-400 hover:text-gray-600">
            <svg class="mr-0.5" style={{width:"24px",height:"24px"}} viewBox="0 0 24 24">
    ...
    <div class="w-80 bg-white p-3">
      <img alt='' class="h-52 w-full object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDZHJIRxAanu1cYkZ3pWuoOZFwicl_wk9Lkg&usqp=CAU" />
      <ul class="mt-3 flex flex-wrap">
        <li class="mr-auto">
          <a href="#" class="flex text-gray-400 hover:text-gray-600">
            <svg class="mr-0.5" style={{width:"24px",height:"24px"}} viewBox="0 0 24 24">
