...
const HomeCard = ({place, handleSelectPlace}) => {
    ...
    return (
        ...
        <div className="mr-4 relative overflow-hidden transition duration-500 transform rounded shadow-xl hover:-translate-y-2 hover:shadow-2xl border border-rose-500">
          <img
