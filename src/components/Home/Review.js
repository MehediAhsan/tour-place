    ...
    return (
        <section data-aos="fade-up" data-aos-duration="1000" className="py-10 pb-3 pt-10 text-gray-200">
            ...
            <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                <div data-aos="fade-right" data-aos-duration="1000" className="flex flex-col items-center mx-12 lg:mx-0">
                ...
                <div data-aos="fade-left" data-aos-duration="1000" className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
                    <div className="relative text-center">
