    ...
    return (
        <div className="flex overflow-hidden rounded mb-8 shadow shadow-rose-400">
            ...
            <div className="px-8 py-5">
                <h1 className="text-2xl font-medium text-rose-200">{name}</h1>
                ...
                <p className="mt-3 text-sm text-gray-200">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus, molestias ex. Reprehenderit excepturi vitae consequatur error quis sequi cupiditate recusandae non, eos doloremque, unde sapiente quasi assumenda a similique corporis.</p>
                    <div className="flex justify-between mt-5 item-center">
                        <h1 className="text-lg font-medium text-gray-400 md:text-xl">${price}</h1>
                        <Link to={`/hotel/${id}`}>
                        <button className="px-2 py-1 text-xs font-medium text-white uppercase transition-colors duration-300 transform bg-rose-500 rounded hover:bg-rose-600">Checkout</button>
                        </Link>
                    </div>
