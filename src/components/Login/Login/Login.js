    ...
    return (
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto">
            ...
            <form className="space-y-6 ng-untouched ng-pristine ng-valid">
                <div>
                    <label for="email" className="block mb-2 text-sm dark:text-gray-400">Email address</label>
                ...
                <div className="space-y-1 text-sm">
                    <label for="password" className="block mb-2 text-sm dark:text-gray-400">Password</label>
                    <input type="password" name="password" id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md border dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" required />
